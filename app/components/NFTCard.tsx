...
const NFTCard = () => {
  return (
    ...
    <div className="absolute inset-0 bg-cyan-500 bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300 rounded-lg z-10 flex items-center justify-center"><Image src="./images/icon-view.svg" alt="View Icon" width={40} height={40} /></div>
          ...
          <div className="w-[278px]">
            <p className="text-white text-2xl mt-4 mb-6 font-normal"><a className="hover:text-[#00FFF8]" href='#'> Equilibrium #3429</a></p>
              ...
              <div className="flex w-full justify-start items-center">
                  <Image className='mr-2' src='./images/icon-ethereum.svg' width={11} height={18} alt='ethereum icon'/>
                  <div className="flex text-[#00FFF8] w-full"><p>0.041 ETH</p>
              </div>
              <div className="flex w-full justify-end items-center">
              <Image className='mr-2' src='./images/icon-clock.svg' width={17} height={4} alt='clock icon' />
