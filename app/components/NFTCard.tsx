          ...
          <div className="w-[278px]">
            <p className="text-white text-2xl mt-4 mb-6 font-normal"><a className="hover:text-[#00FFF8]" href='#'> Equilibrium #3429</a></p>
              ...
              <div className="flex w-full justify-start items-center">
                  <Image className='mr-2' src='/frontend-mentor-nft-preview-card-component/images/icon-ethereum.svg' width={11} height={18} alt='ethereum icon'/>
                  <div className="flex text-[#00FFF8] w-full"><p>0.041 ETH</p>
              </div>
              <div className="flex w-full justify-end items-center">
              <Image className='mr-2' src='/frontend-mentor-nft-preview-card-component/images/icon-clock.svg' width={17} height={4} alt='clock icon' />
              ...
              <Image src='/frontend-mentor-nft-preview-card-component/images/image-avatar.png' width={33} height={33} alt='avatar image' />
              </div>
